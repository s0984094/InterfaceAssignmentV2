...
//Create button and listener for BankAccount      
      JButton button = new JButton("Get " + metric + " Balance");
      panel.add(button);
      //frame.add(panel);
...
//Create button and listener for Country      
      JButton button2 = new JButton("Get " + metric + " Area");
      panel.add(button2);
      ActionListener listener2 = new ButtonListener(countries,metric);
      button2.addActionListener(listener2);
      
//Create button and listener for Quiz      
      JButton button3 = new JButton("Get " + metric + " Score");
      panel.add(button3);
      ActionListener listener3 = new ButtonListener(quizes,metric);
